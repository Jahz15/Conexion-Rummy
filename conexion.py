...
class conexion_Rummy:
        ...
        try:
            while self.ejecutandose:
                ...
                with self.candado:
                    ...
                    # Procesa el mensaje de forma síncrona para notificar a los demás
                    if mensaje.get('type') == 'ClienteDesconectado':
                        ...
                        break # Salir del bucle para cerrar la conexión de este cliente
                    # La función para procesar mensajes va aquí
                    # self._procesar_mensajes()
        except (ConnectionResetError, socket.error) as e:
            # El cliente se desconectó de forma inesperada (ej. cerró la aplicación)
    ...
    def conectar_a_servidor(self, ip_servidor):
        try:
